...
if(slideshow != null){
   // Setting up our variables
     ...
     let slideHeight = null; // we gonna need this later for height calc so we declare it now
     ...
     slideshow.style.height = initHeight + "px";
     ...
     function slideNavigation(n) { 
         ...
         let resizedSlideHeight = slides[currentSlide].clientHeight; // get current slide height
         slideshow.style.height = resizedSlideHeight + "px"; // update height of slideshow
      });
     }
